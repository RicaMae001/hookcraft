...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .order-card { background: #f0fff8; border: 2px solid #86efac; border-radius: 14px; padding: 24px; margin-bottom: 28px; }
    .order-card h2 { font-size: 13px; font-weight: 700; color: #16a34a; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 16px; border-bottom: 1px dashed #86efac; padding-bottom: 10px; }
    .order-row { display: flex; justify-content: space-between; align-items: center; padding: 8px 0; border-bottom: 1px solid #dcfce7; font-size: 14px; }
    .order-row:last-child { border-bottom: none; }
    .order-row .label { color: #999; font-weight: 500; }
    .order-row .value { color: #333; font-weight: 600; text-align: right; max-width: 60%; }
    .status-badge { display: inline-block; background: linear-gradient(135deg, #43e97b, #38f9d7); color: white; padding: 4px 14px; border-radius: 20px; font-size: 13px; font-weight: 700; }
    .items-table { width: 100%; border-collapse: collapse; margin-top: 8px; }
    .items-table th { font-size: 12px; color: #16a34a; text-align: left; padding: 6px 0; border-bottom: 1px dashed #86efac; }
    .items-table td { font-size: 13px; color: #333; padding: 8px 0; border-bottom: 1px solid #dcfce7; }
    .items-table tr:last-child td { border-bottom: none; }
    .total-row { display: flex; justify-content: space-between; align-items: center; background: linear-gradient(135deg, rgba(67,233,123,0.1), rgba(56,249,215,0.1)); border-radius: 10px; padding: 12px 16px; margin-top: 12px; }
    .total-row .total-label { font-size: 15px; font-weight: 700; color: #333; }
    .total-row .total-value { font-size: 17px; font-weight: 800; color: #16a34a; }
    .feedback-box { background: linear-gradient(135deg, #fff8fd, #fdf0f7); border: 2px solid #ffb3d9; border-radius: 14px; padding: 24px; margin-bottom: 28px; text-align: center; }
    .feedback-box p { font-size: 14px; color: #666; margin-bottom: 16px; }
...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <p class="intro">
        Great news! Your order has been successfully delivered. We hope you love your handmade treasure! 🌸
        If you have any concerns about your order, please contact us within 24 hours.
      </p>
      ...
      <div class="order-card">
        ...
        <div class="order-row">
          ...
          <span class="value"><span class="status-badge">✅ Delivered</span></span>
        </div>
      </div>
      ...
      <div class="feedback-box">
        <p>Enjoyed your order? We'd love to hear from you! 💕</p>
        <a href="{{ url('/') }}" class="cta-btn">Shop Again</a>
      </div>
